...
/**
 * Точка сборки игры: создаёт все системы, связывает их и крутит игровой цикл.
 *
 * Здесь же живёт машина состояний (меню → забег → пауза → итог). Состояние
 * держим одной строкой, а не набором флагов: пары `paused && !dead && started`
 * расходятся между собой при первой же правке, а строка не даёт соврать.
 */
